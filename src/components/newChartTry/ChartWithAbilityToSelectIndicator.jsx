...
class ChartWithAbilityToSelectIndicator extends React.Component {
  constructor(props) {
    super(props);
...
ChartWithAbilityToSelectIndicator.propTypes = {
...
ChartWithAbilityToSelectIndicator.defaultProps = {
  type: "svg",
};

ChartWithAbilityToSelectIndicator = fitWidth(
    ChartWithAbilityToSelectIndicator
);

export default ChartWithAbilityToSelectIndicator;
